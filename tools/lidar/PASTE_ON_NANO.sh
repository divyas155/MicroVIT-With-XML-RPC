#!/bin/bash
# Copy this entire file content and paste into Nano terminal, then run:
# chmod +x diagnose_lidar_nano.sh && ./diagnose_lidar_nano.sh

# Create the script on Nano by running this command:
cat > ~/diagnose_lidar_nano.sh << 'SCRIPT_CONTENT'
#!/bin/bash
...
echo "Script created! Now run:"
echo "  ~/diagnose_lidar_nano.sh"
